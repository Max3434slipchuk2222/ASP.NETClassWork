...
namespace _1.WorkingMVC.Migrations
{
    ...
    [Migration("20251118141333_Add tblOrderStatuses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("_1.WorkingMVC.Data.Entities.Identity.RoleEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("_1.WorkingMVC.Data.Entities.ProductImageEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("_1.WorkingMVC.Data.Entities.Identity.RoleEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("_1.WorkingMVC.Data.Entities.Identity.UserEntity", null)
                        .WithMany()
            ...
            modelBuilder.Entity("_1.WorkingMVC.Data.Entities.ProductEntity", b =>
                {
                    b.HasOne("_1.WorkingMVC.Data.Entities.CategoryEntity", "Category")
                        .WithMany("Products")
